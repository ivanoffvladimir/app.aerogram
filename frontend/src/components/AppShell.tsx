...
const AVAILABLE = [
  ...
  { href: '/routing-rules', label: 'Правила' },
 ...
 *
 *  Список пуст: «Правила» уехали наверх вместе с /v1/routing-rules
 *  (ADR-0028), и это был последний приглушённый пункт. Пустым он остаётся
 *  намеренно — сюда попадает следующий экран, объявленный раньше, чем
 *  сделан. «Дашборд» здесь когда-то был лишним: это и есть «Сводка» выше,
 *  а приглушённый пункт рядом с работающим экраном — неправда о готовности,
 *  ровно обратная той, ради которой список существует. */
