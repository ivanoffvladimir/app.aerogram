...
NOT_IMPLEMENTED_YET: frozenset[str] = frozenset(
    {
        # Приём вебхуков перевозчика: тенант неизвестен, пока не найдено
        # отправление по трек-номеру, а найти его можно только чтением
        # поперёк тенантов. Вопросы к решению — в ADR-0015.
