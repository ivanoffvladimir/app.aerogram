...
class Settings(BaseSettings):
    ...
    # --- Автовыбор (ADR-0029) ----------------------------------------------
    #: Рубильник автовыбора. По умолчанию ВЫКЛЮЧЕН: правило, выбирающее
    #: перевозчика без человека, включается решением владельца площадки,
    #: а не выкаткой кода. Пока выключен, решений ``mode = auto`` от правил
    #: не появляется и доля автовыбора в аналитике остаётся честным нулём.
