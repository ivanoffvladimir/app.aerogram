...
#: Телефон в свободном тексте. Границы шире, чем «не цифра»: искать телефон
#: ВНУТРИ слова нельзя. Идентификаторы состоят из тех же цифр и дефисов, и без
#: этой оговорки маска съедала середину UUID — у каждого четвёртого, потому что
#: две соседние группы, целиком цифровые, выглядят как «8-999-123-45-67».
#: Замаскированный идентификатор не опознать в базе, то есть строка лога
#: перестаёт делать то единственное, ради чего написана, — и защищает при этом
#: не человека, а шестнадцатеричное число.
